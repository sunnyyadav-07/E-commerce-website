  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-[#1a1a1a] md:pl-64">
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto p-6 pb-32">
        <form onSubmit={handleOnSubmit} className="space-y-10">
          {/* Form Fields */}
          ...
          <section className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-gray-500 font-medium leading-relaxed max-w-xs">
                Upload up to 7 high-resolution images. Show your craft from
                every angle.
              </p>
            </div>
          ...
          <div className="space-y-4 pt-4">
            <button
              type="submit"
              className="w-full bg-[#3b557e] text-white flex items-center justify-center gap-3 py-4 rounded-xl shadow-lg shadow-[#3b557e]/20 hover:bg-[#2d4363] hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer group"
            >
              <ArrowUpToLine size={18} className="group-hover:animate-bounce" />
              <span className="text-[11px] font-bold tracking-[0.2em] uppercase">
                {isSubmitting ? "Publishing..." : "Publish to Atelier"}
              </span>
            </button>
